        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="pt-6">
            <button
              ...
              className="px-6 py-2 bg-transparent border-2 border-yellow-500 text-yellow-500 rounded-md font-semibold text-lg hover:bg-yellow-500 hover:text-black transition-all duration-300 transform hover:scale-105 cursor-pointer"
            >
              Get started
            </button>
          </div>
